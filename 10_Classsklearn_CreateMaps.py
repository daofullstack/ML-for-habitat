...
#InDir = 'data/Sentinel2/LW_Analysis/SpectralIndices/Composites/WalesCompositesTestarea/TestArea/'
...
print(len(InList))
# 
ModelDir = 'data/Sentinel2/LW_Analysis/SeminaturalMapping_ver3/Ver3Plots_split_set2/Model_xgb_feat50/'
model = ModelDir + 'featurenum_50_model.sav'
skclf = joblib.load(open(model, 'rb'))

featnum = 'featnum_50'
# Output classification image
out_cls_img = ModelDir + featnum + '_SemiNatCom_class_S2medS1Ter_2016to2019_Wales_test.kea'
# Output probability image
out_proba_img = ModelDir +  featnum + '_SemiNatCom_proba_S2medS1Ter_2016to2019_Wales_test.kea'
# Input mask image
img_msk = 'data/Sentinel2/LW_Analysis/SeminaturalMapping_ver3/Feat6Test8_Managed_SemiNat_Wales2019_final_seminatMask_Ext_terrain.kea'

#img_msk = 'data/Sentinel2/LW_Analysis/SeminaturalMapping_ver3/Feat6Test8_Managed_SemiNat_Wales2019_final_seminatMask_testareaExt.kea'
imgs_info = []
...
cls_train_info['3'] = rsgislib.classification.ClassSimpleInfoObj(id=3, fileH5=None, red=90, green=170, blue=200)
cls_train_info['4'] = rsgislib.classification.ClassSimpleInfoObj(id=4, fileH5=None, red=110, green=190, blue=180)
cls_train_info['5'] = rsgislib.classification.ClassSimpleInfoObj(id=5, fileH5=None, red=150, green=210, blue=150)
cls_train_info['6'] = rsgislib.classification.ClassSimpleInfoObj(id=6, fileH5=None, red=170, green=100, blue=120)
cls_train_info['7'] = rsgislib.classification.ClassSimpleInfoObj(id=7, fileH5=None, red=190, green=80, blue=100)
cls_train_info['8'] = rsgislib.classification.ClassSimpleInfoObj(id=8, fileH5=None, red=210, green=60, blue=80)
cls_train_info['9'] = rsgislib.classification.ClassSimpleInfoObj(id=9, fileH5=None, red=10, green=40, blue=50)
#cls_train_info['10'] = rsgislib.classification.ClassSimpleInfoObj(id=10, fileH5=None, red=240, green=20, blue=100)
